function e(e,t){if(e==null||e===``||typeof e==`boolean`)throw RangeError(`${t} must be a finite number.`);let n;try{n=Number(e)}catch{throw RangeError(`${t} must be a finite number.`)}if(!Number.isFinite(n))throw RangeError(`${t} must be a finite number.`);return n}function t(t,n){let r=e(t,n);if(r<0)throw RangeError(`${n} must be greater than or equal to zero.`);return r}function n(t,n){let r=e(t,n);if(r<=0)throw RangeError(`${n} must be greater than zero.`);return r}function r(e,n,r,i){if(t(e,`${i}.min`),t(n,`${i}.target`),t(r,`${i}.max`),e>n||n>r)throw RangeError(`${i} must satisfy 0 <= min <= target <= max.`)}function i(t,n){for(let r of t)e(r.amount,`${n} breakdown item "${r.id}" amount`)}function a(r){for(let i of r){let r=`Field "${i.id}"`;if(i.min!==void 0&&e(i.min,`${r} min`),i.max!==void 0&&e(i.max,`${r} max`),i.step!==void 0&&n(i.step,`${r} step`),i.min!==void 0&&i.max!==void 0&&i.min>i.max)throw RangeError(`${r} must satisfy min <= max.`);i.unitPrice!==void 0&&t(i.unitPrice,`${r} unitPrice`),i.multiplier!==void 0&&n(i.multiplier,`${r} multiplier`);for(let t of i.options||[]){let r=`Option "${i.id}.${t.id}"`;t.adder!==void 0&&e(t.adder,`${r} adder`),t.multiplier!==void 0&&n(t.multiplier,`${r} multiplier`)}}}function o(e=`NYM`){let t=new Date;return`${e}-${t.getFullYear()}${String(t.getMonth()+1).padStart(2,`0`)}${String(t.getDate()).padStart(2,`0`)}-${Array.from(globalThis.crypto.getRandomValues(new Uint8Array(6)),e=>(e%36).toString(36)).join(``).toUpperCase()}`}function s(t,n=`USD`,r=`$`,i=0){let a=e(t,`Currency amount`),o=(i>0?a.toFixed(i):Math.round(a).toString()).split(`.`);return o[0]=o[0].replace(/\B(?=(\d{3})+(?!\d))/g,`,`),`${r}${o.join(`.`)}`}function c(t){if(t==null)return t;if(typeof t==`string`){let e=``,n=!1,r=!1;for(let i=0;i<t.length;i+=1){let a=t[i];if(a===`<`){let e=t.slice(i,i+7).toLowerCase()===`<script`,a=t.slice(i,i+8).toLowerCase()===`<\/script`,o=t[i+(a?8:7)];(e||a)&&(o===`>`||/\s/u.test(o||``))&&(r=e),n=!0}else a===`>`?n=!1:!n&&!r&&(e+=a)}return e.trim()}return typeof t==`number`?e(t,`Numeric input`):Array.isArray(t)?t.map(c):t}function l(e,t){if(!e||!e.fieldId)return!0;let n=t[e.fieldId];switch(e.operator){case`equals`:return n===e.value||String(n)===String(e.value);case`notEquals`:return n!==e.value&&String(n)!==String(e.value);case`greaterThan`:return Number(n)>Number(e.value);case`lessThan`:return Number(n)<Number(e.value);case`in`:return Array.isArray(e.value)?e.value.includes(n):!1;case`contains`:return Array.isArray(n)?n.includes(e.value):typeof n==`string`&&n.includes(String(e.value));default:return!0}}function u(e){if(typeof e!=`string`)return!1;let t=e;if(!t||t.length>254||/\s/u.test(t))return!1;let n=t.indexOf(`@`),r=t.slice(n+1),i=r.lastIndexOf(`.`);return n>0&&n===t.lastIndexOf(`@`)&&i>0&&i<r.length-1}function d(e,t){if(e.required&&(t==null||t===``||Array.isArray(t)&&t.length===0))return{valid:!1,error:`${e.label} is required.`};if(t!=null&&t!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let n;try{n=Number(t)}catch{return{valid:!1,error:`${e.label} must be a valid finite number.`}}if(!Number.isFinite(n))return{valid:!1,error:`${e.label} must be a valid finite number.`};if(e.min!==void 0&&n<e.min)return{valid:!1,error:`Minimum value is ${e.min} ${e.unit||``}`.trim()};if(e.max!==void 0&&n>e.max)return{valid:!1,error:`Maximum value is ${e.max} ${e.unit||``}`.trim()}}if(e.type===`email`&&!u(t))return{valid:!1,error:`Please enter a valid email address.`};if(e.type===`phone`){let e=String(t).replace(/[\s()\-\.]/g,``);if(e.length<7||!/^\+?[0-9]{7,15}$/.test(e))return{valid:!1,error:`Please enter a valid phone number.`}}}return{valid:!0}}function f(t,n){if(e(t,`Rounding amount`),!n||n===`none`)return t;switch(n){case`round`:return Math.round(t);case`ceil`:return Math.ceil(t);case`floor`:return Math.floor(t);case`nearest10`:return Math.round(t/10)*10;case`nearest50`:return Math.round(t/50)*50;case`nearest100`:return Math.round(t/100)*100;default:return t}}function p(c,u){let p=c.pricing?.currency||`USD`,m=c.pricing?.currencySymbol||`$`,h=c.pricing||{},g=u._quoteId||o(),_=[];if(c.steps.forEach(e=>{e.fields.forEach(e=>{_.push(e)})}),a(_),h.formula===`custom`&&typeof h.customFormula==`function`){let e=h.customFormula(u,_);r(e.min,e.target,e.max,`Custom quote result`);let t=e.breakdown||[];i(t,`Custom quote result`);let n=f(e.target,h.rounding),a=f(e.min,h.rounding),o=f(e.max,h.rounding);return r(a,n,o,`Custom quote result`),{min:a,max:o,target:n,formattedMin:s(a,p,m),formattedMax:s(o,p,m),formattedTarget:s(n,p,m),currency:p,currencySymbol:m,breakdown:t,recommendations:[],calculatedAt:new Date().toISOString(),quoteId:g}}let v=h.baseFee===void 0?`pricing.baseCalloutFee`:`pricing.baseFee`,y=t(h.baseFee??h.baseCalloutFee??0,v),b=t(h.taxRate??0,`pricing.taxRate`),x=t(h.marginPercent??10,`pricing.marginPercent`)/100,S=t(h.minRangeSpreadPercent??x*100,`pricing.minRangeSpreadPercent`)/100,C=t(h.maxRangeSpreadPercent??x*100,`pricing.maxRangeSpreadPercent`)/100,w=0,T=0,E=0,D=1,O=[],k=[];y>0&&O.push({id:`base-fee`,label:`Base Callout / Setup Fee`,amount:y,formattedAmount:s(y,p,m),type:`base`,description:`Standard initial mobilization and inspection base`});for(let r of _){if(!l(r.condition,u))continue;let i=u[r.id]===void 0?r.defaultValue:u[r.id];if(i!=null&&i!==``){if(r.type===`number`||r.type===`slider`||r.type===`stepper`){let a=t(i,`Field "${r.id}" value`),o=d(r,a);if(!o.valid)throw RangeError(`Field "${r.id}" is invalid: ${o.error}`);let c=r.unitPrice===void 0?void 0:t(r.unitPrice,`Field "${r.id}" unitPrice`),l=r.multiplier===void 0?void 0:n(r.multiplier,`Field "${r.id}" multiplier`);if(a>0){if(c!==void 0&&c>0){let t=e(a*c,`Field "${r.id}" item cost`);r.category===`material`?w=e(w+t,`Material subtotal`):T=e(T+t,`Labor subtotal`),O.push({id:r.id,label:`${r.label} (${a} ${r.unit||`units`} @ ${s(c,p,m)}/${r.unit||`unit`})`,amount:t,formattedAmount:s(t,p,m),type:r.category===`material`?`material`:`labor`})}l!==void 0&&l!==1&&(D=n(D*l,`Composite multiplier`))}}if((r.type===`select`||r.type===`radio`||r.type===`toggle`)&&r.options&&r.options.length>0){let t=r.options.find(e=>String(e.id)===String(i)||String(e.value)===String(i));if(t){let i=t.adder===void 0?void 0:e(t.adder,`Option "${r.id}.${t.id}" adder`);i!==void 0&&i!==0&&(E=e(E+i,`Add-on subtotal`),O.push({id:`${r.id}-${t.id}`,label:`${r.label}: ${t.label}`,amount:i,formattedAmount:s(i,p,m),type:r.category===`material`?`material`:`addon`,description:t.description}));let a=t.multiplier===void 0?void 0:n(t.multiplier,`Option "${r.id}.${t.id}" multiplier`);a!==void 0&&a!==1&&(D=n(D*a,`Composite multiplier`),O.push({id:`${r.id}-${t.id}-mult`,label:`${t.label} Factor (${a}x)`,amount:0,formattedAmount:`${a}x`,type:`multiplier`,description:t.description}))}}if(r.type===`checkbox`){if(Array.isArray(i)&&r.options)for(let t of i){let i=r.options.find(e=>String(e.id)===String(t)||String(e.value)===String(t));if(i){let t=i.adder===void 0?void 0:e(i.adder,`Option "${r.id}.${i.id}" adder`);t!==void 0&&t!==0&&(E=e(E+t,`Add-on subtotal`),O.push({id:`${r.id}-${i.id}`,label:i.label,amount:t,formattedAmount:s(t,p,m),type:`addon`,description:i.description}));let a=i.multiplier===void 0?void 0:n(i.multiplier,`Option "${r.id}.${i.id}" multiplier`);a!==void 0&&a!==1&&(D=n(D*a,`Composite multiplier`))}}else if(typeof i==`boolean`&&i===!0){let i=r.unitPrice===void 0?void 0:t(r.unitPrice,`Field "${r.id}" unitPrice`);i!==void 0&&i!==0&&(E=e(E+i,`Add-on subtotal`),O.push({id:r.id,label:r.label,amount:i,formattedAmount:s(i,p,m),type:`addon`}));let a=r.multiplier===void 0?void 0:n(r.multiplier,`Field "${r.id}" multiplier`);a!==void 0&&a!==1&&(D=n(D*a,`Composite multiplier`))}}}}let A=e(y+w+T+E,`Quote subtotal`),j=e(A*D,`Multiplied quote target`);if(b>0){let t=e(j*b,`Tax amount`);O.push({id:`tax`,label:`Estimated Tax (${(b*100).toFixed(1)}%)`,amount:t,formattedAmount:s(t,p,m),type:`tax`}),j=e(j+t,`Taxed quote target`)}let M=Math.max(0,j),N=Math.max(0,e(M*(1-S),`Minimum quote bound`)),P=Math.max(M,e(M*(1+C),`Maximum quote bound`));A===0&&y===0&&(M=0,N=0,P=0);let F=f(M,h.rounding),I=f(N,h.rounding),L=f(P,h.rounding);return r(I,F,L,`Quote result`),i(O,`Quote result`),(u.pitch===`steep`||u.difficulty===`extreme`||u.urgency===`emergency`)&&k.push(`Priority Crew Dispatch: Includes safety rigging and on-site supervisor.`),F>5e3&&k.push(`Flexible Financing Available: 0% APR for 12 months on qualifying projects.`),(u.material===`metal`||u.efficiency===`ultra`)&&k.push(`Qualifies for Energy Efficiency Tax Credits & Lifetime Manufacturer Warranty.`),{min:I,max:L,target:F,formattedMin:s(I,p,m),formattedMax:s(L,p,m),formattedTarget:s(F,p,m),currency:p,currencySymbol:m,breakdown:O,recommendations:k,calculatedAt:new Date().toISOString(),quoteId:g}}function m(){return`sess_`+Array.from(globalThis.crypto.getRandomValues(new Uint8Array(16)),e=>e.toString(16).padStart(2,`0`)).join(``)}function h(){if(typeof window>`u`)return`desktop`;let e=navigator.userAgent.toLowerCase(),t=window.innerWidth||1024;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)||t>=768&&t<=1024?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)||t<768?`mobile`:`desktop`}function g(e){if(!e)return``;try{return new URL(e).hostname}catch{return``}}function _(e={}){let t=typeof window<`u`,n=t?new URLSearchParams(window.location.search):new URLSearchParams,r=t&&document.referrer||``,i=t&&window.location.href||``,a=t&&document.title||``,o=t&&navigator.userAgent||``,s=e.customSessionId||``;if(!s&&t){let t=e.storageKey||`nymrel_quote_session_id`;try{s=window.sessionStorage.getItem(t)||``,s||(s=m(),window.sessionStorage.setItem(t,s))}catch{s=m()}}else s||=m();return{utm_source:n.get(`utm_source`)||void 0,utm_medium:n.get(`utm_medium`)||void 0,utm_campaign:n.get(`utm_campaign`)||void 0,utm_term:n.get(`utm_term`)||void 0,utm_content:n.get(`utm_content`)||void 0,gclid:n.get(`gclid`)||void 0,fbclid:n.get(`fbclid`)||void 0,msclkid:n.get(`msclkid`)||void 0,ttclid:n.get(`ttclid`)||void 0,li_fat_id:n.get(`li_fat_id`)||void 0,referrer:r,referring_domain:g(r),landing_page:i,page_title:a,timestamp:new Date().toISOString(),source_label:e.sourceLabel,session_id:s,device_type:h(),userAgent:o}}function v(e,t={},n={}){if(typeof window>`u`)return;let r=n.pushToDataLayer!==!1,i=n.useGtag!==!1,a=n.dispatchDomEvent!==!1,o=`${n.prefix||`nymrel_quote`}_${e}`,s={event:o,...t,timestamp:new Date().toISOString()};if(r){let e=window;e.dataLayer=e.dataLayer||[],e.dataLayer.push(s)}if(i){let e=window;typeof e.gtag==`function`&&e.gtag(`event`,o,t)}if(a)try{let e=new CustomEvent(o,{bubbles:!0,cancelable:!0,detail:s});window.dispatchEvent(e)}catch{}}function y(e,t){v(`viewed`,{schemaId:e,...t})}function b(e,t,n,r){v(`step_completed`,{schemaId:e,stepIndex:t,stepTitle:n,timeSpentMs:r})}function x(e,t,n,r,i){v(`calculated`,{schemaId:e,target:t,min:n,max:r,quoteId:i})}function S(e,t,n,r){v(`lead_submitted`,{schemaId:e,quoteId:t,value:n,currency:`USD`,hasEmail:!!r})}function C(e,t,n){v(`cta_clicked`,{schemaId:e,ctaName:t,quoteId:n})}var w={mode:`warm`,fontFamily:`-apple-system, BlinkMacSystemFont, "Plus Jakarta Sans", "Segoe UI", Roboto, "Helvetica Neue", sans-serif`,primaryColor:`#2A332E`,accentColor:`#A8541F`,accentHoverColor:`#8E4316`,backgroundColor:`#FAF8F2`,surfaceColor:`#F4F0E6`,cardColor:`#FFFFFF`,textColor:`#2A332E`,mutedTextColor:`#637069`,borderColor:`#E2DCCE`,borderRadius:`14px`,boxShadow:`0 8px 30px -4px rgba(42, 51, 46, 0.08), 0 2px 8px -2px rgba(42, 51, 46, 0.04)`,focusRingColor:`rgba(168, 84, 31, 0.28)`},T={mode:`light`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#0F172A`,accentColor:`#2563EB`,accentHoverColor:`#1D4ED8`,backgroundColor:`#F8FAFC`,surfaceColor:`#F1F5F9`,cardColor:`#FFFFFF`,textColor:`#0F172A`,mutedTextColor:`#64748B`,borderColor:`#E2E8F0`,borderRadius:`12px`,boxShadow:`0 4px 20px -2px rgba(0, 0, 0, 0.06)`,focusRingColor:`rgba(37, 99, 235, 0.25)`},E={mode:`dark`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#F1F5F9`,accentColor:`#F97316`,accentHoverColor:`#EA580C`,backgroundColor:`#0F172A`,surfaceColor:`#1E293B`,cardColor:`#1E293B`,textColor:`#F8FAFC`,mutedTextColor:`#94A3B8`,borderColor:`#334155`,borderRadius:`12px`,boxShadow:`0 8px 30px -4px rgba(0, 0, 0, 0.4)`,focusRingColor:`rgba(249, 115, 22, 0.3)`};function D(e){return{...e?.mode===`dark`?E:e?.mode===`light`?T:w,...e}}function O(e){return`
  ...
  `}function A(e=new Date().toISOString()){return{status:`not_configured`,channel:`none`,attemptedAt:e,message:`Local capture only: no delivery destination is configured, so nothing was sent.`}}function j(e=new Date().toISOString()){return{status:`callback_only`,channel:`callback`,attemptedAt:e,message:`Captured locally and handed to this page. No external delivery was attempted.`}}async function M(e,t){let n=new Date().toISOString();try{let r=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`,"X-Nymrel-Quote-Id":t.quoteId},body:JSON.stringify(t)});return r.ok?{status:`accepted`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!0,message:`Your quote was accepted by the destination.`}:{status:`rejected`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!1,message:`Delivery failed: the destination declined this quote (HTTP ${r.status}). Your quote is shown below for your records.`}}catch{return{status:`failed`,channel:`webhook`,attemptedAt:n,ok:!1,message:`Delivery failed: could not reach the destination. Your quote is shown below for your records.`}}}function N(e){return e?e.message:A().message}function P(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var F=class{container;schema;callbacks;formState={};currentStepIndex=0;currentQuote;showBreakdownModal=!1;isSubmitted=!1;isSubmitting=!1;lastSubmission=null;lastDeliveryReceipt=null;sourceLabel;webhookUrl;fieldErrors={};stepStartTime=Date.now();constructor(e,t){this.schema=t.schema,this.callbacks=t.callbacks||{},this.sourceLabel=t.sourceLabel||this.schema.sourceLabel,this.webhookUrl=t.webhookUrl||this.schema.webhookUrl,this.schema.steps.forEach(e=>{e.fields.forEach(e=>{e.defaultValue!==void 0&&(this.formState[e.id]=e.defaultValue)})}),t.initialState&&(this.formState={...this.formState,...t.initialState}),this.container=t.useShadowDom!==!1&&e.attachShadow?e.shadowRoot?e.shadowRoot:e.attachShadow({mode:`open`}):e,this.currentQuote=p(this.schema,this.formState),y(this.schema.id,{sourceLabel:this.sourceLabel}),this.render()}updateState(e,t){this.formState[e]=c(t),delete this.fieldErrors[e],this.recalculate()}recalculate(){return this.currentQuote=p(this.schema,this.formState),x(this.schema.id,this.currentQuote.target,this.currentQuote.min,this.currentQuote.max,this.currentQuote.quoteId),this.callbacks.onCalculate&&this.callbacks.onCalculate(this.currentQuote,this.formState),this.render(),this.currentQuote}nextStep(){if(!this.isLeadFormStep()){let e=this.schema.steps[this.currentStepIndex],t=!1;this.fieldErrors={};for(let n of e.fields){if(!l(n.condition,this.formState))continue;let e=d(n,this.formState[n.id]);e.valid||(this.fieldErrors[n.id]=e.error||`Invalid value`,t=!0)}if(t)return this.render(),!1;let n=Date.now()-this.stepStartTime;if(b(this.schema.id,this.currentStepIndex,e.title,n),this.currentStepIndex<this.schema.steps.length-1)return this.currentStepIndex++,this.stepStartTime=Date.now(),this.callbacks.onStepChange&&this.callbacks.onStepChange(this.currentStepIndex,this.schema.steps[this.currentStepIndex]),this.render(),!0;if(this.isLeadFormEnabled())return this.currentStepIndex++,this.stepStartTime=Date.now(),this.render(),!0}return!1}prevStep(){this.currentStepIndex>0&&(this.currentStepIndex--,this.stepStartTime=Date.now(),this.callbacks.onStepChange&&this.currentStepIndex<this.schema.steps.length&&this.callbacks.onStepChange(this.currentStepIndex,this.schema.steps[this.currentStepIndex]),this.render())}isLeadFormEnabled(){return this.schema.leadForm?.enabled!==!1}isLeadFormStep(){return this.isLeadFormEnabled()&&this.currentStepIndex===this.schema.steps.length}getTotalStepsCount(){return this.schema.steps.length+ +!!this.isLeadFormEnabled()}async submitLead(e){let t=this.schema.leadForm;if(this.fieldErrors={},(!e.name||String(e.name).trim()===``)&&(this.fieldErrors.lead_name=`Full Name is required.`),u(e.email)||(this.fieldErrors.lead_email=`A valid email address is required.`),t?.requirePhone&&(!e.phone||!/^[+]?[(]?[0-9]{3}[)]?[-\s.]?[0-9]{3}[-\s.]?[0-9]{4,6}$/.test(String(e.phone)))&&(this.fieldErrors.lead_phone=`Phone number is required.`),t?.requireAddress&&!e.address&&(this.fieldErrors.lead_address=`Street address or zip code is required.`),Object.keys(this.fieldErrors).length>0)return this.render(),null;this.isSubmitting=!0,this.render();let n=_({sourceLabel:this.sourceLabel}),r={quoteId:this.currentQuote.quoteId,schemaId:this.schema.id,schemaName:this.schema.name,quote:this.currentQuote,formState:{...this.formState},lead:{name:c(e.name),email:c(e.email),phone:c(e.phone||``),address:c(e.address||``),zipCode:c(e.zipCode||``),preferredDate:c(e.preferredDate||``),preferredTime:c(e.preferredTime||``),notes:c(e.notes||``)},attribution:n,submittedAt:new Date().toISOString(),metadata:this.schema.metadata};try{if(this.webhookUrl){let e=await M(this.webhookUrl,r);(e.status===`rejected`||e.status===`failed`)&&console.warn(`[NymrelQuote] Webhook delivery notice:`,e.message),r.delivery=e}else r.delivery=this.callbacks.onSubmit?j():A();if(this.callbacks.onSubmit)try{await this.callbacks.onSubmit(r)}catch(e){r.localHandlingFailed=!0,r.delivery?.channel===`callback`&&(r.delivery={...r.delivery,status:`failed`,ok:!1,message:`The page handler failed. No external delivery was attempted by the widget. Your quote is shown below.`});try{this.callbacks.onError?.(e)}catch{}}try{S(this.schema.id,r.quoteId,this.currentQuote.target,r.lead.email)}catch{}return this.isSubmitting=!1,this.isSubmitted=!0,this.lastSubmission=r,this.lastDeliveryReceipt=r.delivery??null,this.render(),r}catch(e){return this.isSubmitting=!1,this.callbacks.onError&&this.callbacks.onError(e),this.fieldErrors._global=`Submission failed. Please check your connection and try again.`,this.render(),null}}getLastDeliveryReceipt(){return this.lastDeliveryReceipt}reset(){this.formState={},this.schema.steps.forEach(e=>{e.fields.forEach(e=>{e.defaultValue!==void 0&&(this.formState[e.id]=e.defaultValue)})}),this.currentStepIndex=0,this.isSubmitted=!1,this.isSubmitting=!1,this.lastSubmission=null,this.lastDeliveryReceipt=null,this.fieldErrors={},this.recalculate()}printReceipt(){typeof window<`u`&&window.print()}render(){let e=k(this.schema.theme),t=``;t=this.isSubmitted&&this.lastSubmission?this.renderSuccessScreen(this.lastSubmission):this.isLeadFormStep()?this.renderLeadFormStep():this.renderStepForm(this.schema.steps[this.currentStepIndex]);let n=this.showBreakdownModal?this.renderBreakdownModal():``,r=`
      <style>${e}</style>
    ...
    `}renderField(e){if(!l(e.condition,this.formState))return``;let t=this.formState[e.id]===void 0?e.defaultValue??``:this.formState[e.id],n=this.fieldErrors[e.id],r=``;switch(e.type){case`slider`:{let n=e.min??100,i=e.max??5e3,a=e.step??50,o=Number(t)||n;r=`
    ...
    `}attachEventListeners(){this.container.querySelectorAll(`.nym-reactive-input`).forEach(e=>{e.addEventListener(`input`,e=>{let t=e.target,n=t.getAttribute(`data-field-id`);if(n){this.updateState(n,t.value);let e=this.container.querySelector(`#val-${n}`);e&&(e.textContent=`${t.value} ${t.getAttribute(`data-unit`)||``}`.trim())}})}),this.container.querySelectorAll(`.nym-option-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-field-id`),n=e.getAttribute(`data-option-id`);t&&n&&this.updateState(t,n)})}),this.container.querySelectorAll(`.nym-checkbox-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-field-id`),n=e.getAttribute(`data-checkbox-id`);if(t&&n){let e=Array.isArray(this.formState[t])?[...this.formState[t]]:[],r=e.indexOf(n);r>=0?e.splice(r,1):e.push(n),this.updateState(t,e)}})});let e=this.container.querySelector(`#nym-btn-next`);e&&e.addEventListener(`click`,()=>this.nextStep());let t=this.container.querySelector(`#nym-btn-prev`);t&&t.addEventListener(`click`,()=>this.prevStep());let n=this.container.querySelector(`#nym-lead-form`);n&&n.addEventListener(`submit`,e=>{e.preventDefault();let t=new FormData(n),r={};t.forEach((e,t)=>{r[t]=e}),this.submitLead(r)});let r=this.container.querySelector(`#nym-toggle-breakdown`);r&&r.addEventListener(`click`,()=>{this.showBreakdownModal=!0,this.render()});let i=this.container.querySelector(`#nym-modal-close`);i&&i.addEventListener(`click`,()=>{this.showBreakdownModal=!1,this.render()});let a=this.container.querySelector(`#nym-modal-backdrop`);a&&a.addEventListener(`click`,e=>{e.target===a&&(this.showBreakdownModal=!1,this.render())});let o=this.container.querySelector(`#nym-btn-print`);o&&o.addEventListener(`click`,()=>this.printReceipt());let s=this.container.querySelector(`#nym-btn-restart`);s&&s.addEventListener(`click`,()=>this.reset())}};function I(e,t){let n=typeof e==`string`?document.querySelector(e):e;if(!n)throw Error(`[NymrelQuote] Container element not found: ${e}`);return new F(n,t)}Object.defineProperty(exports,"C",{enumerable:!0,get:function(){return s}}),Object.defineProperty(exports,"D",{enumerable:!0,get:function(){return d}}),Object.defineProperty(exports,"E",{enumerable:!0,get:function(){return c}}),Object.defineProperty(exports,"S",{enumerable:!0,get:function(){return l}}),Object.defineProperty(exports,"T",{enumerable:!0,get:function(){return u}}),Object.defineProperty(exports,"_",{enumerable:!0,get:function(){return x}}),Object.defineProperty(exports,"a",{enumerable:!0,get:function(){return E}}),Object.defineProperty(exports,"b",{enumerable:!0,get:function(){return f}}),Object.defineProperty(exports,"c",{enumerable:!0,get:function(){return O}}),Object.defineProperty(exports,"d",{enumerable:!0,get:function(){return v}}),Object.defineProperty(exports,"f",{enumerable:!0,get:function(){return _}}),Object.defineProperty(exports,"g",{enumerable:!0,get:function(){return S}}),Object.defineProperty(exports,"h",{enumerable:!0,get:function(){return C}}),Object.defineProperty(exports,"i",{enumerable:!0,get:function(){return M}}),Object.defineProperty(exports,"l",{enumerable:!0,get:function(){return k}}),Object.defineProperty(exports,"m",{enumerable:!0,get:function(){return g}}),Object.defineProperty(exports,"n",{enumerable:!0,get:function(){return I}}),Object.defineProperty(exports,"o",{enumerable:!0,get:function(){return w}}),Object.defineProperty(exports,"p",{enumerable:!0,get:function(){return h}}),Object.defineProperty(exports,"r",{enumerable:!0,get:function(){return j}}),Object.defineProperty(exports,"s",{enumerable:!0,get:function(){return T}}),Object.defineProperty(exports,"t",{enumerable:!0,get:function(){return F}}),Object.defineProperty(exports,"u",{enumerable:!0,get:function(){return D}}),Object.defineProperty(exports,"v",{enumerable:!0,get:function(){return y}}),Object.defineProperty(exports,"w",{enumerable:!0,get:function(){return o}}),Object.defineProperty(exports,"x",{enumerable:!0,get:function(){return p}}),Object.defineProperty(exports,"y",{enumerable:!0,get:function(){return b}});