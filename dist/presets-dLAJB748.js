			...
			fields: [
				...
				},
				{
					...
					options: [
						{
							id: "1",
							label: "1 Story (Standard Access)",
							value: "1",
							multiplier: 1
						},
						{
							id: "2",
							label: "2 Stories (High Reach)",
							value: "2",
							multiplier: 1.12
						},
						{
							id: "3",
							label: "3+ Stories (Crane / Scaffolding Required)",
							value: "3",
							multiplier: 1.25
						}
					]
			...
			fields: [
				...
				},
				{
					...
					options: [
						{
							id: "simple",
							label: "Basic Email/Password + OAuth (Google/GitHub)",
							value: "simple",
							multiplier: 1
						},
						{
							id: "rbac_social",
							label: "Multi-Tenant RBAC + Team Invitations & Permissions",
							value: "rbac_social",
							multiplier: 1.2,
							adder: 1200
						},
						{
							id: "enterprise_sso",
							label: "Enterprise SAML / Okta SSO + Audit Logging + SOC2 Ready",
...
function a(e) {
	return i[e.toLowerCase().trim()];
}
//#endregion
export { t as a, n as i, a as n, e as o, r, i as t };
