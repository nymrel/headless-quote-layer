const t = {
      ...
      fields: [
        {
          ...
          unit: "sq ft",
          unitPrice: 3.5,
          // Base labor + underlayment per sq ft
          category: "dimension",
          required: !0,
        ...
        },
        {
          ...
          defaultValue: "1",
          options: [
            { id: "1", label: "1 Story (Standard Access)", value: "1", multiplier: 1 },
      ...
      fields: [
        {
          ...
          unit: "sq ft",
          unitPrice: 1.8,
          // Base installation labor per sq ft conditioned
          category: "dimension",
          required: !0
        },
        {
      ...
      fields: [
        {
          ...
          defaultValue: "2",
          options: [
            { id: "1", label: "1 Full Bathroom", value: "1", multiplier: 1 },
            { id: "2", label: "2 Bathrooms", value: "2", multiplier: 1.35 },
            { id: "3", label: "3 Bathrooms", value: "3", multiplier: 1.7 },
            { id: "4", label: "4+ Bathrooms", value: "4", multiplier: 2.1 }
          ]
        },
        {
          id: "job_type",
  ...
  pricing: {
    baseCalloutFee: 1500,
    // Architecture & Discovery sprint base
    marginPercent: 15,
      ...
      fields: [
        {
          ...
          unit: "screens",
          unitPrice: 950,
          // Per responsive screen design + frontend integration
          category: "dimension",
          required: !0
        },
        {
        ...
        },
        {
          ...
          options: [
            { id: "simple", label: "Basic Email/Password + OAuth (Google/GitHub)", value: "simple", multiplier: 1 },
            { id: "rbac_social", label: "Multi-Tenant RBAC + Team Invitations & Permissions", value: "rbac_social", multiplier: 1.2, adder: 1200 },
