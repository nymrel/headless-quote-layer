(function(e,t){typeof exports==`object`&&typeof module<`u`?t(exports):typeof define==`function`&&define.amd?define([`exports`],t):(e=typeof globalThis<`u`?globalThis:e||self,t(e.NymrelQuoteLayer=e.NymrelQuoteLayer||{}))})(this,function(e){Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:`Module`}});function t(e=`NYM`){let t=new Date;return`${e}-${t.getFullYear()}${String(t.getMonth()+1).padStart(2,`0`)}${String(t.getDate()).padStart(2,`0`)}-${Array.from(globalThis.crypto.getRandomValues(new Uint8Array(6)),e=>(e%36).toString(36)).join(``).toUpperCase()}`}function n(e,t=`USD`,n=`$`,r=0){if(isNaN(e)||e==null)return`${n}0`;let i=(r>0?e.toFixed(r):Math.round(e).toString()).split(`.`);return i[0]=i[0].replace(/\B(?=(\d{3})+(?!\d))/g,`,`),`${n}${i.join(`.`)}`}function r(e){if(e==null)return e;if(typeof e==`string`){let t=``,n=!1,r=!1;for(let i=0;i<e.length;i+=1){let a=e[i];if(a===`<`){let t=e.slice(i,i+7).toLowerCase()===`<script`,a=e.slice(i,i+8).toLowerCase()===`<\/script`,o=e[i+(a?8:7)];(t||a)&&(o===`>`||/\s/u.test(o||``))&&(r=t),n=!0}else a===`>`?n=!1:!n&&!r&&(t+=a)}return t.trim()}return typeof e==`number`?isNaN(e)?0:e:Array.isArray(e)?e.map(r):e}function i(e,t){if(!e||!e.fieldId)return!0;let n=t[e.fieldId];switch(e.operator){case`equals`:return n===e.value||String(n)===String(e.value);case`notEquals`:return n!==e.value&&String(n)!==String(e.value);case`greaterThan`:return Number(n)>Number(e.value);case`lessThan`:return Number(n)<Number(e.value);case`in`:return Array.isArray(e.value)?e.value.includes(n):!1;case`contains`:return Array.isArray(n)?n.includes(e.value):typeof n==`string`&&n.includes(String(e.value));default:return!0}}function a(e){if(typeof e!=`string`)return!1;let t=e;if(!t||t.length>254||/\s/u.test(t))return!1;let n=t.indexOf(`@`),r=t.slice(n+1),i=r.lastIndexOf(`.`);return n>0&&n===t.lastIndexOf(`@`)&&i>0&&i<r.length-1}function o(e,t){if(e.required&&(t==null||t===``||Array.isArray(t)&&t.length===0))return{valid:!1,error:`${e.label} is required.`};if(t!=null&&t!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let n=Number(t);if(isNaN(n))return{valid:!1,error:`${e.label} must be a valid number.`};if(e.min!==void 0&&n<e.min)return{valid:!1,error:`Minimum value is ${e.min} ${e.unit||``}`.trim()};if(e.max!==void 0&&n>e.max)return{valid:!1,error:`Maximum value is ${e.max} ${e.unit||``}`.trim()}}if(e.type===`email`&&!a(t))return{valid:!1,error:`Please enter a valid email address.`};if(e.type===`phone`){let e=String(t).replace(/[\s()\-\.]/g,``);if(e.length<7||!/^\+?[0-9]{7,15}$/.test(e))return{valid:!1,error:`Please enter a valid phone number.`}}}return{valid:!0}}function s(e,t){if(!t||t===`none`)return e;switch(t){case`round`:return Math.round(e);case`ceil`:return Math.ceil(e);case`floor`:return Math.floor(e);case`nearest10`:return Math.round(e/10)*10;case`nearest50`:return Math.round(e/50)*50;case`nearest100`:return Math.round(e/100)*100;default:return e}}function c(e,r){let a=e.pricing?.currency||`USD`,o=e.pricing?.currencySymbol||`$`,c=e.pricing||{},l=r._quoteId||t(),u=[];if(e.steps.forEach(e=>{e.fields.forEach(e=>{u.push(e)})}),c.formula===`custom`&&typeof c.customFormula==`function`){let e=c.customFormula(r,u),t=s(e.target,c.rounding),i=s(e.min,c.rounding),d=s(e.max,c.rounding);return{min:i,max:d,target:t,formattedMin:n(i,a,o),formattedMax:n(d,a,o),formattedTarget:n(t,a,o),currency:a,currencySymbol:o,breakdown:e.breakdown||[],recommendations:[],calculatedAt:new Date().toISOString(),quoteId:l}}let d=Number(c.baseFee||c.baseCalloutFee||0),f=0,p=0,m=0,h=1,g=[],_=[];d>0&&g.push({id:`base-fee`,label:`Base Callout / Setup Fee`,amount:d,formattedAmount:n(d,a,o),type:`base`,description:`Standard initial mobilization and inspection base`});for(let e of u){if(!i(e.condition,r))continue;let t=r[e.id]===void 0?e.defaultValue:r[e.id];if(t!=null&&t!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let r=Number(t);if(!isNaN(r)&&r>0){if(e.unitPrice&&e.unitPrice>0){let t=r*e.unitPrice;e.category===`material`?f+=t:p+=t,g.push({id:e.id,label:`${e.label} (${r} ${e.unit||`units`} @ ${n(e.unitPrice,a,o)}/${e.unit||`unit`})`,amount:t,formattedAmount:n(t,a,o),type:e.category===`material`?`material`:`labor`})}e.multiplier&&e.multiplier!==1&&(h*=e.multiplier)}}if((e.type===`select`||e.type===`radio`||e.type===`toggle`)&&e.options&&e.options.length>0){let r=e.options.find(e=>String(e.id)===String(t)||String(e.value)===String(t));if(r){if(r.adder&&Number(r.adder)!==0){let t=Number(r.adder);m+=t,g.push({id:`${e.id}-${r.id}`,label:`${e.label}: ${r.label}`,amount:t,formattedAmount:n(t,a,o),type:e.category===`material`?`material`:`addon`,description:r.description})}if(r.multiplier&&Number(r.multiplier)!==1){let t=Number(r.multiplier);h*=t,g.push({id:`${e.id}-${r.id}-mult`,label:`${r.label} Factor (${t}x)`,amount:0,formattedAmount:`${t}x`,type:`multiplier`,description:r.description})}}}if(e.type===`checkbox`){if(Array.isArray(t)&&e.options)for(let r of t){let t=e.options.find(e=>String(e.id)===String(r)||String(e.value)===String(r));if(t){if(t.adder&&Number(t.adder)!==0){let r=Number(t.adder);m+=r,g.push({id:`${e.id}-${t.id}`,label:t.label,amount:r,formattedAmount:n(r,a,o),type:`addon`,description:t.description})}t.multiplier&&Number(t.multiplier)!==1&&(h*=Number(t.multiplier))}}else typeof t==`boolean`&&t===!0&&(e.unitPrice&&(m+=e.unitPrice,g.push({id:e.id,label:e.label,amount:e.unitPrice,formattedAmount:n(e.unitPrice,a,o),type:`addon`})),e.multiplier&&e.multiplier!==1&&(h*=e.multiplier))}}}let v=d+f+p+m,y=v*h;if(c.taxRate&&c.taxRate>0){let e=y*c.taxRate;g.push({id:`tax`,label:`Estimated Tax (${(c.taxRate*100).toFixed(1)}%)`,amount:e,formattedAmount:n(e,a,o),type:`tax`}),y+=e}let b=c.marginPercent?c.marginPercent/100:.1,x=c.minRangeSpreadPercent?c.minRangeSpreadPercent/100:b,S=c.maxRangeSpreadPercent?c.maxRangeSpreadPercent/100:b,C=Math.max(0,y),w=Math.max(0,C*(1-x)),T=Math.max(w,C*(1+S));v===0&&d===0&&(C=0,w=0,T=0);let E=s(C,c.rounding),D=s(w,c.rounding),O=s(T,c.rounding);return(r.pitch===`steep`||r.difficulty===`extreme`||r.urgency===`emergency`)&&_.push(`Priority Crew Dispatch: Includes safety rigging and on-site supervisor.`),E>5e3&&_.push(`Flexible Financing Available: 0% APR for 12 months on qualifying projects.`),(r.material===`metal`||r.efficiency===`ultra`)&&_.push(`Qualifies for Energy Efficiency Tax Credits & Lifetime Manufacturer Warranty.`),{min:D,max:O,target:E,formattedMin:n(D,a,o),formattedMax:n(O,a,o),formattedTarget:n(E,a,o),currency:a,currencySymbol:o,breakdown:g,recommendations:_,calculatedAt:new Date().toISOString(),quoteId:l}}function l(e=new Date().toISOString()){return{status:`not_configured`,channel:`none`,attemptedAt:e,message:`Local capture only: no delivery destination is configured, so nothing was sent.`}}function u(e=new Date().toISOString()){return{status:`callback_only`,channel:`callback`,attemptedAt:e,message:`Captured locally and handed to this page. No external delivery was attempted.`}}async function d(e,t){let n=new Date().toISOString();try{let r=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`,"X-Nymrel-Quote-Id":t.quoteId},body:JSON.stringify(t)});return r.ok?{status:`accepted`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!0,message:`Your quote was accepted by the destination.`}:{status:`rejected`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!1,message:`Delivery failed: the destination declined this quote (HTTP ${r.status}). Your quote is shown below for your records.`}}catch{return{status:`failed`,channel:`webhook`,attemptedAt:n,ok:!1,message:`Delivery failed: could not reach the destination. Your quote is shown below for your records.`}}}function f(e){return e?e.message:l().message}function p(){return`sess_`+Array.from(globalThis.crypto.getRandomValues(new Uint8Array(16)),e=>e.toString(16).padStart(2,`0`)).join(``)}function m(){if(typeof window>`u`)return`desktop`;let e=navigator.userAgent.toLowerCase(),t=window.innerWidth||1024;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)||t>=768&&t<=1024?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)||t<768?`mobile`:`desktop`}function h(e){if(!e)return``;try{return new URL(e).hostname}catch{return``}}function g(e={}){let t=typeof window<`u`,n=t?new URLSearchParams(window.location.search):new URLSearchParams,r=t&&document.referrer||``,i=t&&window.location.href||``,a=t&&document.title||``,o=t&&navigator.userAgent||``,s=e.customSessionId||``;if(!s&&t){let t=e.storageKey||`nymrel_quote_session_id`;try{s=window.sessionStorage.getItem(t)||``,s||(s=p(),window.sessionStorage.setItem(t,s))}catch{s=p()}}else s||=p();return{utm_source:n.get(`utm_source`)||void 0,utm_medium:n.get(`utm_medium`)||void 0,utm_campaign:n.get(`utm_campaign`)||void 0,utm_term:n.get(`utm_term`)||void 0,utm_content:n.get(`utm_content`)||void 0,gclid:n.get(`gclid`)||void 0,fbclid:n.get(`fbclid`)||void 0,msclkid:n.get(`msclkid`)||void 0,ttclid:n.get(`ttclid`)||void 0,li_fat_id:n.get(`li_fat_id`)||void 0,referrer:r,referring_domain:h(r),landing_page:i,page_title:a,timestamp:new Date().toISOString(),source_label:e.sourceLabel,session_id:s,device_type:m(),userAgent:o}}function _(e,t={},n={}){if(typeof window>`u`)return;let r=n.pushToDataLayer!==!1,i=n.useGtag!==!1,a=n.dispatchDomEvent!==!1,o=`${n.prefix||`nymrel_quote`}_${e}`,s={event:o,...t,timestamp:new Date().toISOString()};if(r){let e=window;e.dataLayer=e.dataLayer||[],e.dataLayer.push(s)}if(i){let e=window;typeof e.gtag==`function`&&e.gtag(`event`,o,t)}if(a)try{let e=new CustomEvent(o,{bubbles:!0,cancelable:!0,detail:s});window.dispatchEvent(e)}catch{}}function v(e,t){_(`viewed`,{schemaId:e,...t})}function y(e,t,n,r){_(`step_completed`,{schemaId:e,stepIndex:t,stepTitle:n,timeSpentMs:r})}function b(e,t,n,r,i){_(`calculated`,{schemaId:e,target:t,min:n,max:r,quoteId:i})}function x(e,t,n,r){_(`lead_submitted`,{schemaId:e,quoteId:t,value:n,currency:`USD`,hasEmail:!!r})}var S={mode:`warm`,fontFamily:`-apple-system, BlinkMacSystemFont, "Plus Jakarta Sans", "Segoe UI", Roboto, "Helvetica Neue", sans-serif`,primaryColor:`#2A332E`,accentColor:`#A8541F`,accentHoverColor:`#8E4316`,backgroundColor:`#FAF8F2`,surfaceColor:`#F4F0E6`,cardColor:`#FFFFFF`,textColor:`#2A332E`,mutedTextColor:`#637069`,borderColor:`#E2DCCE`,borderRadius:`14px`,boxShadow:`0 8px 30px -4px rgba(42, 51, 46, 0.08), 0 2px 8px -2px rgba(42, 51, 46, 0.04)`,focusRingColor:`rgba(168, 84, 31, 0.28)`},C={mode:`light`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#0F172A`,accentColor:`#2563EB`,accentHoverColor:`#1D4ED8`,backgroundColor:`#F8FAFC`,surfaceColor:`#F1F5F9`,cardColor:`#FFFFFF`,textColor:`#0F172A`,mutedTextColor:`#64748B`,borderColor:`#E2E8F0`,borderRadius:`12px`,boxShadow:`0 4px 20px -2px rgba(0, 0, 0, 0.06)`,focusRingColor:`rgba(37, 99, 235, 0.25)`},w={mode:`dark`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#F1F5F9`,accentColor:`#F97316`,accentHoverColor:`#EA580C`,backgroundColor:`#0F172A`,surfaceColor:`#1E293B`,cardColor:`#1E293B`,textColor:`#F8FAFC`,mutedTextColor:`#94A3B8`,borderColor:`#334155`,borderRadius:`12px`,boxShadow:`0 8px 30px -4px rgba(0, 0, 0, 0.4)`,focusRingColor:`rgba(249, 115, 22, 0.3)`};function T(e){return{...e?.mode===`dark`?w:e?.mode===`light`?C:S,...e}}function E(e){return`
  ...
  `}function O(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var k=class{container;schema;callbacks;formState={};currentStepIndex=0;currentQuote;showBreakdownModal=!1;isSubmitted=!1;isSubmitting=!1;lastSubmission=null;lastDeliveryReceipt=null;sourceLabel;webhookUrl;fieldErrors={};stepStartTime=Date.now();constructor(e,t){this.schema=t.schema,this.callbacks=t.callbacks||{},this.sourceLabel=t.sourceLabel||this.schema.sourceLabel,this.webhookUrl=t.webhookUrl||this.schema.webhookUrl,this.schema.steps.forEach(e=>{e.fields.forEach(e=>{e.defaultValue!==void 0&&(this.formState[e.id]=e.defaultValue)})}),t.initialState&&(this.formState={...this.formState,...t.initialState}),this.container=t.useShadowDom!==!1&&e.attachShadow?e.shadowRoot?e.shadowRoot:e.attachShadow({mode:`open`}):e,this.currentQuote=c(this.schema,this.formState),v(this.schema.id,{sourceLabel:this.sourceLabel}),this.render()}updateState(e,t){this.formState[e]=r(t),delete this.fieldErrors[e],this.recalculate()}recalculate(){return this.currentQuote=c(this.schema,this.formState),b(this.schema.id,this.currentQuote.target,this.currentQuote.min,this.currentQuote.max,this.currentQuote.quoteId),this.callbacks.onCalculate&&this.callbacks.onCalculate(this.currentQuote,this.formState),this.render(),this.currentQuote}nextStep(){if(!this.isLeadFormStep()){let e=this.schema.steps[this.currentStepIndex],t=!1;this.fieldErrors={};for(let n of e.fields){if(!i(n.condition,this.formState))continue;let e=o(n,this.formState[n.id]);e.valid||(this.fieldErrors[n.id]=e.error||`Invalid value`,t=!0)}if(t)return this.render(),!1;let n=Date.now()-this.stepStartTime;if(y(this.schema.id,this.currentStepIndex,e.title,n),this.currentStepIndex<this.schema.steps.length-1)return this.currentStepIndex++,this.stepStartTime=Date.now(),this.callbacks.onStepChange&&this.callbacks.onStepChange(this.currentStepIndex,this.schema.steps[this.currentStepIndex]),this.render(),!0;if(this.isLeadFormEnabled())return this.currentStepIndex++,this.stepStartTime=Date.now(),this.render(),!0}return!1}prevStep(){this.currentStepIndex>0&&(this.currentStepIndex--,this.stepStartTime=Date.now(),this.callbacks.onStepChange&&this.currentStepIndex<this.schema.steps.length&&this.callbacks.onStepChange(this.currentStepIndex,this.schema.steps[this.currentStepIndex]),this.render())}isLeadFormEnabled(){return this.schema.leadForm?.enabled!==!1}isLeadFormStep(){return this.isLeadFormEnabled()&&this.currentStepIndex===this.schema.steps.length}getTotalStepsCount(){return this.schema.steps.length+ +!!this.isLeadFormEnabled()}async submitLead(e){let t=this.schema.leadForm;if(this.fieldErrors={},(!e.name||String(e.name).trim()===``)&&(this.fieldErrors.lead_name=`Full Name is required.`),a(e.email)||(this.fieldErrors.lead_email=`A valid email address is required.`),t?.requirePhone&&(!e.phone||!/^[+]?[(]?[0-9]{3}[)]?[-\s.]?[0-9]{3}[-\s.]?[0-9]{4,6}$/.test(String(e.phone)))&&(this.fieldErrors.lead_phone=`Phone number is required.`),t?.requireAddress&&!e.address&&(this.fieldErrors.lead_address=`Street address or zip code is required.`),Object.keys(this.fieldErrors).length>0)return this.render(),null;this.isSubmitting=!0,this.render();let n=g({sourceLabel:this.sourceLabel}),i={quoteId:this.currentQuote.quoteId,schemaId:this.schema.id,schemaName:this.schema.name,quote:this.currentQuote,formState:{...this.formState},lead:{name:r(e.name),email:r(e.email),phone:r(e.phone||``),address:r(e.address||``),zipCode:r(e.zipCode||``),preferredDate:r(e.preferredDate||``),preferredTime:r(e.preferredTime||``),notes:r(e.notes||``)},attribution:n,submittedAt:new Date().toISOString(),metadata:this.schema.metadata};try{if(this.webhookUrl){let e=await d(this.webhookUrl,i);(e.status===`rejected`||e.status===`failed`)&&console.warn(`[NymrelQuote] Webhook delivery notice:`,e.message),i.delivery=e}else i.delivery=this.callbacks.onSubmit?u():l();if(this.callbacks.onSubmit)try{await this.callbacks.onSubmit(i)}catch(e){i.localHandlingFailed=!0,i.delivery?.channel===`callback`&&(i.delivery={...i.delivery,status:`failed`,ok:!1,message:`The page handler failed. No external delivery was attempted by the widget. Your quote is shown below.`});try{this.callbacks.onError?.(e)}catch{}}try{x(this.schema.id,i.quoteId,this.currentQuote.target,i.lead.email)}catch{}return this.isSubmitting=!1,this.isSubmitted=!0,this.lastSubmission=i,this.lastDeliveryReceipt=i.delivery??null,this.render(),i}catch(e){return this.isSubmitting=!1,this.callbacks.onError&&this.callbacks.onError(e),this.fieldErrors._global=`Submission failed. Please check your connection and try again.`,this.render(),null}}getLastDeliveryReceipt(){return this.lastDeliveryReceipt}reset(){this.formState={},this.schema.steps.forEach(e=>{e.fields.forEach(e=>{e.defaultValue!==void 0&&(this.formState[e.id]=e.defaultValue)})}),this.currentStepIndex=0,this.isSubmitted=!1,this.isSubmitting=!1,this.lastSubmission=null,this.lastDeliveryReceipt=null,this.fieldErrors={},this.recalculate()}printReceipt(){typeof window<`u`&&window.print()}render(){let e=D(this.schema.theme),t=``;t=this.isSubmitted&&this.lastSubmission?this.renderSuccessScreen(this.lastSubmission):this.isLeadFormStep()?this.renderLeadFormStep():this.renderStepForm(this.schema.steps[this.currentStepIndex]);let n=this.showBreakdownModal?this.renderBreakdownModal():``,r=`
      <style>${e}</style>
    ...
    `}renderField(e){if(!i(e.condition,this.formState))return``;let t=this.formState[e.id]===void 0?e.defaultValue??``:this.formState[e.id],n=this.fieldErrors[e.id],r=``;switch(e.type){case`slider`:{let n=e.min??100,i=e.max??5e3,a=e.step??50,o=Number(t)||n;r=`
      ...
      <div class="nym-success-screen">
        ...
        <div class="nym-receipt-card">
          <div class="nym-delivery-status nym-receipt-row" role="status">
            ...
            <span class="nym-receipt-val">${O(f(this.lastDeliveryReceipt))}</span>
          </div>
