(function(e,t){typeof exports==`object`&&typeof module<`u`?t(exports):typeof define==`function`&&define.amd?define([`exports`],t):(e=typeof globalThis<`u`?globalThis:e||self,t(e.NymrelQuoteLayer=e.NymrelQuoteLayer||{}))})(this,function(e){Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:`Module`}});function t(e=`NYM`){let t=new Date;return`${e}-${t.getFullYear()}${String(t.getMonth()+1).padStart(2,`0`)}${String(t.getDate()).padStart(2,`0`)}-${Array.from(globalThis.crypto.getRandomValues(new Uint8Array(6)),e=>(e%36).toString(36)).join(``).toUpperCase()}`}function n(e,t=`USD`,n=`$`,r=0){if(isNaN(e)||e==null)return`${n}0`;let i=(r>0?e.toFixed(r):Math.round(e).toString()).split(`.`);return i[0]=i[0].replace(/\B(?=(\d{3})+(?!\d))/g,`,`),`${n}${i.join(`.`)}`}function r(e){if(e==null)return e;if(typeof e==`string`){let t=``,n=!1,r=!1;for(let i=0;i<e.length;i+=1){let a=e[i];if(a===`<`){let t=e.slice(i,i+7).toLowerCase()===`<script`,a=e.slice(i,i+8).toLowerCase()===`<\/script`,o=e[i+(a?8:7)];(t||a)&&(o===`>`||/\s/u.test(o||``))&&(r=t),n=!0}else a===`>`?n=!1:!n&&!r&&(t+=a)}return t.trim()}return typeof e==`number`?isNaN(e)?0:e:Array.isArray(e)?e.map(r):e}function i(e,t){if(!e||!e.fieldId)return!0;let n=t[e.fieldId];switch(e.operator){case`equals`:return n===e.value||String(n)===String(e.value);case`notEquals`:return n!==e.value&&String(n)!==String(e.value);case`greaterThan`:return Number(n)>Number(e.value);case`lessThan`:return Number(n)<Number(e.value);case`in`:return Array.isArray(e.value)?e.value.includes(n):!1;case`contains`:return Array.isArray(n)?n.includes(e.value):typeof n==`string`&&n.includes(String(e.value));default:return!0}}function a(e,t){if(e.required&&(t==null||t===``||Array.isArray(t)&&t.length===0))return{valid:!1,error:`${e.label} is required.`};if(t!=null&&t!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let n=Number(t);if(isNaN(n))return{valid:!1,error:`${e.label} must be a valid number.`};if(e.min!==void 0&&n<e.min)return{valid:!1,error:`Minimum value is ${e.min} ${e.unit||``}`.trim()};if(e.max!==void 0&&n>e.max)return{valid:!1,error:`Maximum value is ${e.max} ${e.unit||``}`.trim()}}if(e.type===`email`&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(t)))return{valid:!1,error:`Please enter a valid email address.`};if(e.type===`phone`){let e=String(t).replace(/[\s()\-\.]/g,``);if(e.length<7||!/^\+?[0-9]{7,15}$/.test(e))return{valid:!1,error:`Please enter a valid phone number.`}}}return{valid:!0}}function o(e,t){if(!t||t===`none`)return e;switch(t){case`round`:return Math.round(e);case`ceil`:return Math.ceil(e);case`floor`:return Math.floor(e);case`nearest10`:return Math.round(e/10)*10;case`nearest50`:return Math.round(e/50)*50;case`nearest100`:return Math.round(e/100)*100;default:return e}}function s(e,r){let a=e.pricing?.currency||`USD`,s=e.pricing?.currencySymbol||`$`,c=e.pricing||{},l=r._quoteId||t(),u=[];if(e.steps.forEach(e=>{e.fields.forEach(e=>{u.push(e)})}),c.formula===`custom`&&typeof c.customFormula==`function`){let e=c.customFormula(r,u),t=o(e.target,c.rounding),i=o(e.min,c.rounding),d=o(e.max,c.rounding);return{min:i,max:d,target:t,formattedMin:n(i,a,s),formattedMax:n(d,a,s),formattedTarget:n(t,a,s),currency:a,currencySymbol:s,breakdown:e.breakdown||[],recommendations:[],calculatedAt:new Date().toISOString(),quoteId:l}}let d=Number(c.baseFee||c.baseCalloutFee||0),f=0,p=0,m=0,h=1,g=[],_=[];d>0&&g.push({id:`base-fee`,label:`Base Callout / Setup Fee`,amount:d,formattedAmount:n(d,a,s),type:`base`,description:`Standard initial mobilization and inspection base`});for(let e of u){if(!i(e.condition,r))continue;let t=r[e.id]===void 0?e.defaultValue:r[e.id];if(t!=null&&t!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let r=Number(t);if(!isNaN(r)&&r>0){if(e.unitPrice&&e.unitPrice>0){let t=r*e.unitPrice;e.category===`material`?f+=t:p+=t,g.push({id:e.id,label:`${e.label} (${r} ${e.unit||`units`} @ ${n(e.unitPrice,a,s)}/${e.unit||`unit`})`,amount:t,formattedAmount:n(t,a,s),type:e.category===`material`?`material`:`labor`})}e.multiplier&&e.multiplier!==1&&(h*=e.multiplier)}}if((e.type===`select`||e.type===`radio`||e.type===`toggle`)&&e.options&&e.options.length>0){let r=e.options.find(e=>String(e.id)===String(t)||String(e.value)===String(t));if(r){if(r.adder&&Number(r.adder)!==0){let t=Number(r.adder);m+=t,g.push({id:`${e.id}-${r.id}`,label:`${e.label}: ${r.label}`,amount:t,formattedAmount:n(t,a,s),type:e.category===`material`?`material`:`addon`,description:r.description})}if(r.multiplier&&Number(r.multiplier)!==1){let t=Number(r.multiplier);h*=t,g.push({id:`${e.id}-${r.id}-mult`,label:`${r.label} Factor (${t}x)`,amount:0,formattedAmount:`${t}x`,type:`multiplier`,description:r.description})}}}if(e.type===`checkbox`){if(Array.isArray(t)&&e.options)for(let r of t){let t=e.options.find(e=>String(e.id)===String(r)||String(e.value)===String(r));if(t){if(t.adder&&Number(t.adder)!==0){let r=Number(t.adder);m+=r,g.push({id:`${e.id}-${t.id}`,label:t.label,amount:r,formattedAmount:n(r,a,s),type:`addon`,description:t.description})}t.multiplier&&Number(t.multiplier)!==1&&(h*=Number(t.multiplier))}}else typeof t==`boolean`&&t===!0&&(e.unitPrice&&(m+=e.unitPrice,g.push({id:e.id,label:e.label,amount:e.unitPrice,formattedAmount:n(e.unitPrice,a,s),type:`addon`})),e.multiplier&&e.multiplier!==1&&(h*=e.multiplier))}}}let v=d+f+p+m,y=v*h;if(c.taxRate&&c.taxRate>0){let e=y*c.taxRate;g.push({id:`tax`,label:`Estimated Tax (${(c.taxRate*100).toFixed(1)}%)`,amount:e,formattedAmount:n(e,a,s),type:`tax`}),y+=e}let b=c.marginPercent?c.marginPercent/100:.1,x=c.minRangeSpreadPercent?c.minRangeSpreadPercent/100:b,S=c.maxRangeSpreadPercent?c.maxRangeSpreadPercent/100:b,C=Math.max(0,y),w=Math.max(0,C*(1-x)),T=Math.max(w,C*(1+S));v===0&&d===0&&(C=0,w=0,T=0);let E=o(C,c.rounding),D=o(w,c.rounding),O=o(T,c.rounding);return(r.pitch===`steep`||r.difficulty===`extreme`||r.urgency===`emergency`)&&_.push(`Priority Crew Dispatch: Includes safety rigging and on-site supervisor.`),E>5e3&&_.push(`Flexible Financing Available: 0% APR for 12 months on qualifying projects.`),(r.material===`metal`||r.efficiency===`ultra`)&&_.push(`Qualifies for Energy Efficiency Tax Credits & Lifetime Manufacturer Warranty.`),{min:D,max:O,target:E,formattedMin:n(D,a,s),formattedMax:n(O,a,s),formattedTarget:n(E,a,s),currency:a,currencySymbol:s,breakdown:g,recommendations:_,calculatedAt:new Date().toISOString(),quoteId:l}}function c(e=new Date().toISOString()){return{status:`not_configured`,channel:`none`,attemptedAt:e,message:`Local capture only: no delivery destination is configured, so nothing was sent.`}}function l(e=new Date().toISOString()){return{status:`callback_only`,channel:`callback`,attemptedAt:e,message:`Captured locally and handed to this page. No external delivery was attempted.`}}async function u(e,t){let n=new Date().toISOString();try{let r=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`,"X-Nymrel-Quote-Id":t.quoteId},body:JSON.stringify(t)});return r.ok?{status:`accepted`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!0,message:`Your quote was accepted by the destination.`}:{status:`rejected`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!1,message:`Delivery failed: the destination declined this quote (HTTP ${r.status}). Your quote is shown below for your records.`}}catch{return{status:`failed`,channel:`webhook`,attemptedAt:n,ok:!1,message:`Delivery failed: could not reach the destination. Your quote is shown below for your records.`}}}function d(e){return e?e.message:c().message}function f(){return`sess_`+Array.from(globalThis.crypto.getRandomValues(new Uint8Array(16)),e=>e.toString(16).padStart(2,`0`)).join(``)}function p(){if(typeof window>`u`)return`desktop`;let e=navigator.userAgent.toLowerCase(),t=window.innerWidth||1024;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)||t>=768&&t<=1024?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)||t<768?`mobile`:`desktop`}function m(e){if(!e)return``;try{return new URL(e).hostname}catch{return``}}function h(e={}){let t=typeof window<`u`,n=t?new URLSearchParams(window.location.search):new URLSearchParams,r=t&&document.referrer||``,i=t&&window.location.href||``,a=t&&document.title||``,o=t&&navigator.userAgent||``,s=e.customSessionId||``;if(!s&&t){let t=e.storageKey||`nymrel_quote_session_id`;try{s=window.sessionStorage.getItem(t)||``,s||(s=f(),window.sessionStorage.setItem(t,s))}catch{s=f()}}else s||=f();return{utm_source:n.get(`utm_source`)||void 0,utm_medium:n.get(`utm_medium`)||void 0,utm_campaign:n.get(`utm_campaign`)||void 0,utm_term:n.get(`utm_term`)||void 0,utm_content:n.get(`utm_content`)||void 0,gclid:n.get(`gclid`)||void 0,fbclid:n.get(`fbclid`)||void 0,msclkid:n.get(`msclkid`)||void 0,ttclid:n.get(`ttclid`)||void 0,li_fat_id:n.get(`li_fat_id`)||void 0,referrer:r,referring_domain:m(r),landing_page:i,page_title:a,timestamp:new Date().toISOString(),source_label:e.sourceLabel,session_id:s,device_type:p(),userAgent:o}}function g(e,t={},n={}){if(typeof window>`u`)return;let r=n.pushToDataLayer!==!1,i=n.useGtag!==!1,a=n.dispatchDomEvent!==!1,o=`${n.prefix||`nymrel_quote`}_${e}`,s={event:o,...t,timestamp:new Date().toISOString()};if(r){let e=window;e.dataLayer=e.dataLayer||[],e.dataLayer.push(s)}if(i){let e=window;typeof e.gtag==`function`&&e.gtag(`event`,o,t)}if(a)try{let e=new CustomEvent(o,{bubbles:!0,cancelable:!0,detail:s});window.dispatchEvent(e)}catch{}}function _(e,t){g(`viewed`,{schemaId:e,...t})}function v(e,t,n,r){g(`step_completed`,{schemaId:e,stepIndex:t,stepTitle:n,timeSpentMs:r})}function y(e,t,n,r,i){g(`calculated`,{schemaId:e,target:t,min:n,max:r,quoteId:i})}function b(e,t,n,r){g(`lead_submitted`,{schemaId:e,quoteId:t,value:n,currency:`USD`,hasEmail:!!r})}var x={mode:`warm`,fontFamily:`-apple-system, BlinkMacSystemFont, "Plus Jakarta Sans", "Segoe UI", Roboto, "Helvetica Neue", sans-serif`,primaryColor:`#2A332E`,accentColor:`#A8541F`,accentHoverColor:`#8E4316`,backgroundColor:`#FAF8F2`,surfaceColor:`#F4F0E6`,cardColor:`#FFFFFF`,textColor:`#2A332E`,mutedTextColor:`#637069`,borderColor:`#E2DCCE`,borderRadius:`14px`,boxShadow:`0 8px 30px -4px rgba(42, 51, 46, 0.08), 0 2px 8px -2px rgba(42, 51, 46, 0.04)`,focusRingColor:`rgba(168, 84, 31, 0.28)`},S={mode:`light`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#0F172A`,accentColor:`#2563EB`,accentHoverColor:`#1D4ED8`,backgroundColor:`#F8FAFC`,surfaceColor:`#F1F5F9`,cardColor:`#FFFFFF`,textColor:`#0F172A`,mutedTextColor:`#64748B`,borderColor:`#E2E8F0`,borderRadius:`12px`,boxShadow:`0 4px 20px -2px rgba(0, 0, 0, 0.06)`,focusRingColor:`rgba(37, 99, 235, 0.25)`},C={mode:`dark`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#F1F5F9`,accentColor:`#F97316`,accentHoverColor:`#EA580C`,backgroundColor:`#0F172A`,surfaceColor:`#1E293B`,cardColor:`#1E293B`,textColor:`#F8FAFC`,mutedTextColor:`#94A3B8`,borderColor:`#334155`,borderRadius:`12px`,boxShadow:`0 8px 30px -4px rgba(0, 0, 0, 0.4)`,focusRingColor:`rgba(249, 115, 22, 0.3)`};function w(e){return{...e?.mode===`dark`?C:e?.mode===`light`?S:x,...e}}function T(e){return`
      ...
      <div class="nym-success-screen">
        ...
        <div class="nym-receipt-card">
          <div class="nym-delivery-status nym-receipt-row" role="status">
            ...
            <span class="nym-receipt-val">${D(d(this.lastDeliveryReceipt))}</span>
          </div>
