(function(e,t){typeof exports==`object`&&typeof module<`u`?t(exports):typeof define==`function`&&define.amd?define([`exports`],t):(e=typeof globalThis<`u`?globalThis:e||self,t(e.NymrelQuoteLayer=e.NymrelQuoteLayer||{}))})(this,function(e){Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:`Module`}});function t(e,t){if(e==null||e===``||typeof e==`boolean`)throw RangeError(`${t} must be a finite number.`);let n;try{n=Number(e)}catch{throw RangeError(`${t} must be a finite number.`)}if(!Number.isFinite(n))throw RangeError(`${t} must be a finite number.`);return n}function n(e,n){let r=t(e,n);if(r<0)throw RangeError(`${n} must be greater than or equal to zero.`);return r}function r(e,n){let r=t(e,n);if(r<=0)throw RangeError(`${n} must be greater than zero.`);return r}function i(e,t,r,i){if(n(e,`${i}.min`),n(t,`${i}.target`),n(r,`${i}.max`),e>t||t>r)throw RangeError(`${i} must satisfy 0 <= min <= target <= max.`)}function a(e,n){for(let r of e)t(r.amount,`${n} breakdown item "${r.id}" amount`)}function o(e){for(let i of e){let e=`Field "${i.id}"`;if(i.min!==void 0&&t(i.min,`${e} min`),i.max!==void 0&&t(i.max,`${e} max`),i.step!==void 0&&r(i.step,`${e} step`),i.min!==void 0&&i.max!==void 0&&i.min>i.max)throw RangeError(`${e} must satisfy min <= max.`);i.unitPrice!==void 0&&n(i.unitPrice,`${e} unitPrice`),i.multiplier!==void 0&&r(i.multiplier,`${e} multiplier`);for(let e of i.options||[]){let n=`Option "${i.id}.${e.id}"`;e.adder!==void 0&&t(e.adder,`${n} adder`),e.multiplier!==void 0&&r(e.multiplier,`${n} multiplier`)}}}function s(e=`NYM`){let t=new Date;return`${e}-${t.getFullYear()}${String(t.getMonth()+1).padStart(2,`0`)}${String(t.getDate()).padStart(2,`0`)}-${Array.from(globalThis.crypto.getRandomValues(new Uint8Array(6)),e=>(e%36).toString(36)).join(``).toUpperCase()}`}function c(e,n=`USD`,r=`$`,i=0){let a=t(e,`Currency amount`),o=(i>0?a.toFixed(i):Math.round(a).toString()).split(`.`);return o[0]=o[0].replace(/\B(?=(\d{3})+(?!\d))/g,`,`),`${r}${o.join(`.`)}`}function l(e){if(e==null)return e;if(typeof e==`string`){let t=``,n=!1,r=!1;for(let i=0;i<e.length;i+=1){let a=e[i];if(a===`<`){let t=e.slice(i,i+7).toLowerCase()===`<script`,a=e.slice(i,i+8).toLowerCase()===`<\/script`,o=e[i+(a?8:7)];(t||a)&&(o===`>`||/\s/u.test(o||``))&&(r=t),n=!0}else a===`>`?n=!1:!n&&!r&&(t+=a)}return t.trim()}return typeof e==`number`?t(e,`Numeric input`):Array.isArray(e)?e.map(l):e}function u(e,t){if(!e||!e.fieldId)return!0;let n=t[e.fieldId];switch(e.operator){case`equals`:return n===e.value||String(n)===String(e.value);case`notEquals`:return n!==e.value&&String(n)!==String(e.value);case`greaterThan`:return Number(n)>Number(e.value);case`lessThan`:return Number(n)<Number(e.value);case`in`:return Array.isArray(e.value)?e.value.includes(n):!1;case`contains`:return Array.isArray(n)?n.includes(e.value):typeof n==`string`&&n.includes(String(e.value));default:return!0}}function d(e){if(typeof e!=`string`)return!1;let t=e;if(!t||t.length>254||/\s/u.test(t))return!1;let n=t.indexOf(`@`),r=t.slice(n+1),i=r.lastIndexOf(`.`);return n>0&&n===t.lastIndexOf(`@`)&&i>0&&i<r.length-1}function f(e,t){if(e.required&&(t==null||t===``||Array.isArray(t)&&t.length===0))return{valid:!1,error:`${e.label} is required.`};if(t!=null&&t!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let n;try{n=Number(t)}catch{return{valid:!1,error:`${e.label} must be a valid finite number.`}}if(!Number.isFinite(n))return{valid:!1,error:`${e.label} must be a valid finite number.`};if(e.min!==void 0&&n<e.min)return{valid:!1,error:`Minimum value is ${e.min} ${e.unit||``}`.trim()};if(e.max!==void 0&&n>e.max)return{valid:!1,error:`Maximum value is ${e.max} ${e.unit||``}`.trim()}}if(e.type===`email`&&!d(t))return{valid:!1,error:`Please enter a valid email address.`};if(e.type===`phone`){let e=String(t).replace(/[\s()\-\.]/g,``);if(e.length<7||!/^\+?[0-9]{7,15}$/.test(e))return{valid:!1,error:`Please enter a valid phone number.`}}}return{valid:!0}}function p(e,n){if(t(e,`Rounding amount`),!n||n===`none`)return e;switch(n){case`round`:return Math.round(e);case`ceil`:return Math.ceil(e);case`floor`:return Math.floor(e);case`nearest10`:return Math.round(e/10)*10;case`nearest50`:return Math.round(e/50)*50;case`nearest100`:return Math.round(e/100)*100;default:return e}}function m(e,l){let d=e.pricing?.currency||`USD`,m=e.pricing?.currencySymbol||`$`,h=e.pricing||{},g=l._quoteId||s(),_=[];if(e.steps.forEach(e=>{e.fields.forEach(e=>{_.push(e)})}),o(_),h.formula===`custom`&&typeof h.customFormula==`function`){let e=h.customFormula(l,_);i(e.min,e.target,e.max,`Custom quote result`);let t=e.breakdown||[];a(t,`Custom quote result`);let n=p(e.target,h.rounding),r=p(e.min,h.rounding),o=p(e.max,h.rounding);return i(r,n,o,`Custom quote result`),{min:r,max:o,target:n,formattedMin:c(r,d,m),formattedMax:c(o,d,m),formattedTarget:c(n,d,m),currency:d,currencySymbol:m,breakdown:t,recommendations:[],calculatedAt:new Date().toISOString(),quoteId:g}}let v=h.baseFee===void 0?`pricing.baseCalloutFee`:`pricing.baseFee`,y=n(h.baseFee??h.baseCalloutFee??0,v),b=n(h.taxRate??0,`pricing.taxRate`),x=n(h.marginPercent??10,`pricing.marginPercent`)/100,S=n(h.minRangeSpreadPercent??x*100,`pricing.minRangeSpreadPercent`)/100,C=n(h.maxRangeSpreadPercent??x*100,`pricing.maxRangeSpreadPercent`)/100,w=0,T=0,E=0,D=1,O=[],k=[];y>0&&O.push({id:`base-fee`,label:`Base Callout / Setup Fee`,amount:y,formattedAmount:c(y,d,m),type:`base`,description:`Standard initial mobilization and inspection base`});for(let e of _){if(!u(e.condition,l))continue;let i=l[e.id]===void 0?e.defaultValue:l[e.id];if(i!=null&&i!==``){if(e.type===`number`||e.type===`slider`||e.type===`stepper`){let a=n(i,`Field "${e.id}" value`),o=f(e,a);if(!o.valid)throw RangeError(`Field "${e.id}" is invalid: ${o.error}`);let s=e.unitPrice===void 0?void 0:n(e.unitPrice,`Field "${e.id}" unitPrice`),l=e.multiplier===void 0?void 0:r(e.multiplier,`Field "${e.id}" multiplier`);if(a>0){if(s!==void 0&&s>0){let n=t(a*s,`Field "${e.id}" item cost`);e.category===`material`?w=t(w+n,`Material subtotal`):T=t(T+n,`Labor subtotal`),O.push({id:e.id,label:`${e.label} (${a} ${e.unit||`units`} @ ${c(s,d,m)}/${e.unit||`unit`})`,amount:n,formattedAmount:c(n,d,m),type:e.category===`material`?`material`:`labor`})}l!==void 0&&l!==1&&(D=r(D*l,`Composite multiplier`))}}if((e.type===`select`||e.type===`radio`||e.type===`toggle`)&&e.options&&e.options.length>0){let n=e.options.find(e=>String(e.id)===String(i)||String(e.value)===String(i));if(n){let i=n.adder===void 0?void 0:t(n.adder,`Option "${e.id}.${n.id}" adder`);i!==void 0&&i!==0&&(E=t(E+i,`Add-on subtotal`),O.push({id:`${e.id}-${n.id}`,label:`${e.label}: ${n.label}`,amount:i,formattedAmount:c(i,d,m),type:e.category===`material`?`material`:`addon`,description:n.description}));let a=n.multiplier===void 0?void 0:r(n.multiplier,`Option "${e.id}.${n.id}" multiplier`);a!==void 0&&a!==1&&(D=r(D*a,`Composite multiplier`),O.push({id:`${e.id}-${n.id}-mult`,label:`${n.label} Factor (${a}x)`,amount:0,formattedAmount:`${a}x`,type:`multiplier`,description:n.description}))}}if(e.type===`checkbox`){if(Array.isArray(i)&&e.options)for(let n of i){let i=e.options.find(e=>String(e.id)===String(n)||String(e.value)===String(n));if(i){let n=i.adder===void 0?void 0:t(i.adder,`Option "${e.id}.${i.id}" adder`);n!==void 0&&n!==0&&(E=t(E+n,`Add-on subtotal`),O.push({id:`${e.id}-${i.id}`,label:i.label,amount:n,formattedAmount:c(n,d,m),type:`addon`,description:i.description}));let a=i.multiplier===void 0?void 0:r(i.multiplier,`Option "${e.id}.${i.id}" multiplier`);a!==void 0&&a!==1&&(D=r(D*a,`Composite multiplier`))}}else if(typeof i==`boolean`&&i===!0){let i=e.unitPrice===void 0?void 0:n(e.unitPrice,`Field "${e.id}" unitPrice`);i!==void 0&&i!==0&&(E=t(E+i,`Add-on subtotal`),O.push({id:e.id,label:e.label,amount:i,formattedAmount:c(i,d,m),type:`addon`}));let a=e.multiplier===void 0?void 0:r(e.multiplier,`Field "${e.id}" multiplier`);a!==void 0&&a!==1&&(D=r(D*a,`Composite multiplier`))}}}}let A=t(y+w+T+E,`Quote subtotal`),j=t(A*D,`Multiplied quote target`);if(b>0){let e=t(j*b,`Tax amount`);O.push({id:`tax`,label:`Estimated Tax (${(b*100).toFixed(1)}%)`,amount:e,formattedAmount:c(e,d,m),type:`tax`}),j=t(j+e,`Taxed quote target`)}let M=Math.max(0,j),N=Math.max(0,t(M*(1-S),`Minimum quote bound`)),P=Math.max(M,t(M*(1+C),`Maximum quote bound`));A===0&&y===0&&(M=0,N=0,P=0);let F=p(M,h.rounding),I=p(N,h.rounding),L=p(P,h.rounding);return i(I,F,L,`Quote result`),a(O,`Quote result`),(l.pitch===`steep`||l.difficulty===`extreme`||l.urgency===`emergency`)&&k.push(`Priority Crew Dispatch: Includes safety rigging and on-site supervisor.`),F>5e3&&k.push(`Flexible Financing Available: 0% APR for 12 months on qualifying projects.`),(l.material===`metal`||l.efficiency===`ultra`)&&k.push(`Qualifies for Energy Efficiency Tax Credits & Lifetime Manufacturer Warranty.`),{min:I,max:L,target:F,formattedMin:c(I,d,m),formattedMax:c(L,d,m),formattedTarget:c(F,d,m),currency:d,currencySymbol:m,breakdown:O,recommendations:k,calculatedAt:new Date().toISOString(),quoteId:g}}function h(e=new Date().toISOString()){return{status:`not_configured`,channel:`none`,attemptedAt:e,message:`Local capture only: no delivery destination is configured, so nothing was sent.`}}function g(e=new Date().toISOString()){return{status:`callback_only`,channel:`callback`,attemptedAt:e,message:`Captured locally and handed to this page. No external delivery was attempted.`}}async function _(e,t){let n=new Date().toISOString();try{let r=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`,"X-Nymrel-Quote-Id":t.quoteId},body:JSON.stringify(t)});return r.ok?{status:`accepted`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!0,message:`Your quote was accepted by the destination.`}:{status:`rejected`,channel:`webhook`,attemptedAt:n,httpStatus:r.status,ok:!1,message:`Delivery failed: the destination declined this quote (HTTP ${r.status}). Your quote is shown below for your records.`}}catch{return{status:`failed`,channel:`webhook`,attemptedAt:n,ok:!1,message:`Delivery failed: could not reach the destination. Your quote is shown below for your records.`}}}function v(e){return e?e.message:h().message}function y(){return`sess_`+Array.from(globalThis.crypto.getRandomValues(new Uint8Array(16)),e=>e.toString(16).padStart(2,`0`)).join(``)}function b(){if(typeof window>`u`)return`desktop`;let e=navigator.userAgent.toLowerCase(),t=window.innerWidth||1024;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)||t>=768&&t<=1024?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)||t<768?`mobile`:`desktop`}function x(e){if(!e)return``;try{return new URL(e).hostname}catch{return``}}function S(e={}){let t=typeof window<`u`,n=t?new URLSearchParams(window.location.search):new URLSearchParams,r=t&&document.referrer||``,i=t&&window.location.href||``,a=t&&document.title||``,o=t&&navigator.userAgent||``,s=e.customSessionId||``;if(!s&&t){let t=e.storageKey||`nymrel_quote_session_id`;try{s=window.sessionStorage.getItem(t)||``,s||(s=y(),window.sessionStorage.setItem(t,s))}catch{s=y()}}else s||=y();return{utm_source:n.get(`utm_source`)||void 0,utm_medium:n.get(`utm_medium`)||void 0,utm_campaign:n.get(`utm_campaign`)||void 0,utm_term:n.get(`utm_term`)||void 0,utm_content:n.get(`utm_content`)||void 0,gclid:n.get(`gclid`)||void 0,fbclid:n.get(`fbclid`)||void 0,msclkid:n.get(`msclkid`)||void 0,ttclid:n.get(`ttclid`)||void 0,li_fat_id:n.get(`li_fat_id`)||void 0,referrer:r,referring_domain:x(r),landing_page:i,page_title:a,timestamp:new Date().toISOString(),source_label:e.sourceLabel,session_id:s,device_type:b(),userAgent:o}}function C(e,t={},n={}){if(typeof window>`u`)return;let r=n.pushToDataLayer!==!1,i=n.useGtag!==!1,a=n.dispatchDomEvent!==!1,o=`${n.prefix||`nymrel_quote`}_${e}`,s={event:o,...t,timestamp:new Date().toISOString()};if(r){let e=window;e.dataLayer=e.dataLayer||[],e.dataLayer.push(s)}if(i){let e=window;typeof e.gtag==`function`&&e.gtag(`event`,o,t)}if(a)try{let e=new CustomEvent(o,{bubbles:!0,cancelable:!0,detail:s});window.dispatchEvent(e)}catch{}}function w(e,t){C(`viewed`,{schemaId:e,...t})}function T(e,t,n,r){C(`step_completed`,{schemaId:e,stepIndex:t,stepTitle:n,timeSpentMs:r})}function E(e,t,n,r,i){C(`calculated`,{schemaId:e,target:t,min:n,max:r,quoteId:i})}function D(e,t,n,r){C(`lead_submitted`,{schemaId:e,quoteId:t,value:n,currency:`USD`,hasEmail:!!r})}var O={mode:`warm`,fontFamily:`-apple-system, BlinkMacSystemFont, "Plus Jakarta Sans", "Segoe UI", Roboto, "Helvetica Neue", sans-serif`,primaryColor:`#2A332E`,accentColor:`#A8541F`,accentHoverColor:`#8E4316`,backgroundColor:`#FAF8F2`,surfaceColor:`#F4F0E6`,cardColor:`#FFFFFF`,textColor:`#2A332E`,mutedTextColor:`#637069`,borderColor:`#E2DCCE`,borderRadius:`14px`,boxShadow:`0 8px 30px -4px rgba(42, 51, 46, 0.08), 0 2px 8px -2px rgba(42, 51, 46, 0.04)`,focusRingColor:`rgba(168, 84, 31, 0.28)`},k={mode:`light`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#0F172A`,accentColor:`#2563EB`,accentHoverColor:`#1D4ED8`,backgroundColor:`#F8FAFC`,surfaceColor:`#F1F5F9`,cardColor:`#FFFFFF`,textColor:`#0F172A`,mutedTextColor:`#64748B`,borderColor:`#E2E8F0`,borderRadius:`12px`,boxShadow:`0 4px 20px -2px rgba(0, 0, 0, 0.06)`,focusRingColor:`rgba(37, 99, 235, 0.25)`},A={mode:`dark`,fontFamily:`-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`,primaryColor:`#F1F5F9`,accentColor:`#F97316`,accentHoverColor:`#EA580C`,backgroundColor:`#0F172A`,surfaceColor:`#1E293B`,cardColor:`#1E293B`,textColor:`#F8FAFC`,mutedTextColor:`#94A3B8`,borderColor:`#334155`,borderRadius:`12px`,boxShadow:`0 8px 30px -4px rgba(0, 0, 0, 0.4)`,focusRingColor:`rgba(249, 115, 22, 0.3)`};function j(e){return{...e?.mode===`dark`?A:e?.mode===`light`?k:O,...e}}function M(e){return`
  ...
  `}function P(e){return e==null?``:String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}var F=class{container;schema;callbacks;formState={};currentStepIndex=0;currentQuote;showBreakdownModal=!1;isSubmitted=!1;isSubmitting=!1;lastSubmission=null;lastDeliveryReceipt=null;sourceLabel;webhookUrl;fieldErrors={};stepStartTime=Date.now();constructor(e,t){this.schema=t.schema,this.callbacks=t.callbacks||{},this.sourceLabel=t.sourceLabel||this.schema.sourceLabel,this.webhookUrl=t.webhookUrl||this.schema.webhookUrl,this.schema.steps.forEach(e=>{e.fields.forEach(e=>{e.defaultValue!==void 0&&(this.formState[e.id]=e.defaultValue)})}),t.initialState&&(this.formState={...this.formState,...t.initialState}),this.container=t.useShadowDom!==!1&&e.attachShadow?e.shadowRoot?e.shadowRoot:e.attachShadow({mode:`open`}):e,this.currentQuote=m(this.schema,this.formState),w(this.schema.id,{sourceLabel:this.sourceLabel}),this.render()}updateState(e,t){this.formState[e]=l(t),delete this.fieldErrors[e],this.recalculate()}recalculate(){return this.currentQuote=m(this.schema,this.formState),E(this.schema.id,this.currentQuote.target,this.currentQuote.min,this.currentQuote.max,this.currentQuote.quoteId),this.callbacks.onCalculate&&this.callbacks.onCalculate(this.currentQuote,this.formState),this.render(),this.currentQuote}nextStep(){if(!this.isLeadFormStep()){let e=this.schema.steps[this.currentStepIndex],t=!1;this.fieldErrors={};for(let n of e.fields){if(!u(n.condition,this.formState))continue;let e=f(n,this.formState[n.id]);e.valid||(this.fieldErrors[n.id]=e.error||`Invalid value`,t=!0)}if(t)return this.render(),!1;let n=Date.now()-this.stepStartTime;if(T(this.schema.id,this.currentStepIndex,e.title,n),this.currentStepIndex<this.schema.steps.length-1)return this.currentStepIndex++,this.stepStartTime=Date.now(),this.callbacks.onStepChange&&this.callbacks.onStepChange(this.currentStepIndex,this.schema.steps[this.currentStepIndex]),this.render(),!0;if(this.isLeadFormEnabled())return this.currentStepIndex++,this.stepStartTime=Date.now(),this.render(),!0}return!1}prevStep(){this.currentStepIndex>0&&(this.currentStepIndex--,this.stepStartTime=Date.now(),this.callbacks.onStepChange&&this.currentStepIndex<this.schema.steps.length&&this.callbacks.onStepChange(this.currentStepIndex,this.schema.steps[this.currentStepIndex]),this.render())}isLeadFormEnabled(){return this.schema.leadForm?.enabled!==!1}isLeadFormStep(){return this.isLeadFormEnabled()&&this.currentStepIndex===this.schema.steps.length}getTotalStepsCount(){return this.schema.steps.length+ +!!this.isLeadFormEnabled()}async submitLead(e){let t=this.schema.leadForm;if(this.fieldErrors={},(!e.name||String(e.name).trim()===``)&&(this.fieldErrors.lead_name=`Full Name is required.`),d(e.email)||(this.fieldErrors.lead_email=`A valid email address is required.`),t?.requirePhone&&(!e.phone||!/^[+]?[(]?[0-9]{3}[)]?[-\s.]?[0-9]{3}[-\s.]?[0-9]{4,6}$/.test(String(e.phone)))&&(this.fieldErrors.lead_phone=`Phone number is required.`),t?.requireAddress&&!e.address&&(this.fieldErrors.lead_address=`Street address or zip code is required.`),Object.keys(this.fieldErrors).length>0)return this.render(),null;this.isSubmitting=!0,this.render();let n=S({sourceLabel:this.sourceLabel}),r={quoteId:this.currentQuote.quoteId,schemaId:this.schema.id,schemaName:this.schema.name,quote:this.currentQuote,formState:{...this.formState},lead:{name:l(e.name),email:l(e.email),phone:l(e.phone||``),address:l(e.address||``),zipCode:l(e.zipCode||``),preferredDate:l(e.preferredDate||``),preferredTime:l(e.preferredTime||``),notes:l(e.notes||``)},attribution:n,submittedAt:new Date().toISOString(),metadata:this.schema.metadata};try{if(this.webhookUrl){let e=await _(this.webhookUrl,r);(e.status===`rejected`||e.status===`failed`)&&console.warn(`[NymrelQuote] Webhook delivery notice:`,e.message),r.delivery=e}else r.delivery=this.callbacks.onSubmit?g():h();if(this.callbacks.onSubmit)try{await this.callbacks.onSubmit(r)}catch(e){r.localHandlingFailed=!0,r.delivery?.channel===`callback`&&(r.delivery={...r.delivery,status:`failed`,ok:!1,message:`The page handler failed. No external delivery was attempted by the widget. Your quote is shown below.`});try{this.callbacks.onError?.(e)}catch{}}try{D(this.schema.id,r.quoteId,this.currentQuote.target,r.lead.email)}catch{}return this.isSubmitting=!1,this.isSubmitted=!0,this.lastSubmission=r,this.lastDeliveryReceipt=r.delivery??null,this.render(),r}catch(e){return this.isSubmitting=!1,this.callbacks.onError&&this.callbacks.onError(e),this.fieldErrors._global=`Submission failed. Please check your connection and try again.`,this.render(),null}}getLastDeliveryReceipt(){return this.lastDeliveryReceipt}reset(){this.formState={},this.schema.steps.forEach(e=>{e.fields.forEach(e=>{e.defaultValue!==void 0&&(this.formState[e.id]=e.defaultValue)})}),this.currentStepIndex=0,this.isSubmitted=!1,this.isSubmitting=!1,this.lastSubmission=null,this.lastDeliveryReceipt=null,this.fieldErrors={},this.recalculate()}printReceipt(){typeof window<`u`&&window.print()}render(){let e=N(this.schema.theme),t=``;t=this.isSubmitted&&this.lastSubmission?this.renderSuccessScreen(this.lastSubmission):this.isLeadFormStep()?this.renderLeadFormStep():this.renderStepForm(this.schema.steps[this.currentStepIndex]);let n=this.showBreakdownModal?this.renderBreakdownModal():``,r=`
      <style>${e}</style>
    ...
    `}renderField(e){if(!u(e.condition,this.formState))return``;let t=this.formState[e.id]===void 0?e.defaultValue??``:this.formState[e.id],n=this.fieldErrors[e.id],r=``;switch(e.type){case`slider`:{let n=e.min??100,i=e.max??5e3,a=e.step??50,o=Number(t)||n;r=`
      ...
      <div class="nym-success-screen">
        ...
        <div class="nym-receipt-card">
          <div class="nym-delivery-status nym-receipt-row" role="status">
            ...
            <span class="nym-receipt-val">${P(v(this.lastDeliveryReceipt))}</span>
          </div>
